...
void TetrisWindow::drawSidebar(QPainter &painter) {
    ...
    // Draw Score
    painter.drawText(FIELD_WIDTH * blockSize + 10, 50, "Score: " + QString::number(game.score));
    painter.drawText(FIELD_WIDTH * blockSize + 10, 80, "Level: " + QString::number(game.level));
